    ...
    render() {
        ...
        const list = this.props.boardState.board.map(item => {
            if (item.boardShortcutEditActive) {
                ...
                return (
                    <li key={item.boardId} className='board__shortcuts__listItem' data-id={item.boardId} onMouseEnter={this.showItemsList} onMouseLeave={this.showItemsList} onClick={this.showListBody}>
                        {item.boardName}
